Imports System.Drawing.Drawing2D ' For design 
...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Set styles when the form is loaded
        SetTextBoxStyle()
        SetButtonStyle()
    ...
    ' For rooting po // limited na po sya for up to 5 decimal places
    Private Sub ButtonX_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Double.TryParse(TextBox1.Text, input) Then
            TextBox1.Text = Math.Sqrt(input).ToString()
        Else
